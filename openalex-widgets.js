...
(function () {
  ...
  function injectStyles() {
    ...
    style.textContent += '\n' + [
      ...
      /* CSS-only tooltip */
      '[data-oax-tooltip] { position: relative; cursor: help; }',
      ...
      '.oax-ap-card__stats { display: flex; border: 1px solid #e9e5e4; border-radius: 4px; }',
      '.oax-ap-card__stat { flex: 1; text-align: center; padding: 7px 4px; border-right: 1px solid #e9e5e4; }',
      '.oax-ap-card__stat:first-child { border-radius: 4px 0 0 4px; }',
      '.oax-ap-card__stat:last-child { border-right: none; border-radius: 0 4px 4px 0; }',
